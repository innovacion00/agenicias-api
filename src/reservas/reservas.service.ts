...
export class ReservasService {
          ...
          [
            {
              ...
              desglosePrecios: createReservaDto.desglosePrecios || [],
            },
          ],
          { session },
        );
  ...
  /**
   * Actualiza el abono registrado por fuera de la plataforma para una reserva
   * identificada por su reservaChatbotId.
   */
          ...
          [
            {
              ...
              desglosePrecios: dto.desglosePrecios || [],
            },
          ],
          { session },
        );
          ...
          [
            {
              ...
              desglosePrecios: reservaOrigen.desglosePrecios || [],
              reservaProvider: 'autocore',
              esReactivacion: true,
